 ...
 * build time: Sat Jan 23 2021 14:59:56 GMT+0800 (中国标准时间)
*/
...
!function(t) {
    ...
    var a = [], i = i.SHA256 = r.extend({
        ...
        _doProcessBlock: function(t, e) {
            for (var r = this._hash.words, n = r[0], i = r[1], s = r[2], c = r[3], h = r[4], u = r[5], f = r[6], l = r[7], d = 0; 64 > d; d++) {
                if (16 > d) a[d] = 0 | t[e + d]; else {
                    var p = a[d - 15], _ = a[d - 2];
                    a[d] = ((p << 25 | p >>> 7) ^ (p << 14 | p >>> 18) ^ p >>> 3) + a[d - 7] + ((_ << 15 | _ >>> 17) ^ (_ << 13 | _ >>> 19) ^ _ >>> 10) + a[d - 16];
                }
                p = l + ((h << 26 | h >>> 6) ^ (h << 21 | h >>> 11) ^ (h << 7 | h >>> 25)) + (h & u ^ ~h & f) + o[d] + a[d], 
                _ = ((n << 30 | n >>> 2) ^ (n << 19 | n >>> 13) ^ (n << 10 | n >>> 22)) + (n & i ^ n & s ^ i & s), 
                l = f, f = u, u = h, h = c + p | 0, c = s, s = i, i = n, n = p + _ | 0;
            }
    ...
    var t = CryptoJS, e = t.lib.WordArray, r = t.algo, n = r.SHA256, r = r.SHA224 = n.extend({
        _doReset: function() {
            this._hash = e.create([ 3238371032, 914150663, 812702999, 4144912697, 4290775857, 1750603025, 1694076839, 3204075428 ]);
        },
        _doFinalize: function() {
            n._doFinalize.call(this), this._hash.sigBytes -= 4;
        }
    });
    t.SHA224 = n._createHelper(r), t.HmacSHA224 = n._createHmacHelper(r);
}(), function() {
